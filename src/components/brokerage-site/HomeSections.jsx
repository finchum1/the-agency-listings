...
import IdxListings from "./IdxListings";
...
// closes, same as agent-site/HomeSections.jsx. Agents/Areas/Blog/Listings
// render in their "preview" (capped, "View All"/"see more" link) form
// here — the standalone /brokerage/agents, /brokerage/areas,
// /brokerage/blog, and /brokerage/listings pages each show the full list.
const SECTION_COMPONENTS = {
  about: About,
  agents: () => <AgentRoster preview />,
  areas: () => <AreasOfExpertise preview />,
  blog: () => <BlogList preview />,
  listings: () => <IdxListings preview />,
};
